...
const BotName = ''🕹️ΜØĐŞ Ł€Ø ΔPҜ ŴPP👾📡2.0; 
const instagram = 'http://www.instagram.com/'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN: 🕹️ΜØĐŞ Ł€Ø ΔPҜ ŴPP👾📡2.0\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=554591291250: +55 45 9129-1250\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Hola@${num.split('@')[0]}\n Sea bienvenido(a) al grupo *${mdata.subject}*\n\n Tienes 5 minutos para dar un "UP" y lea las reglas en la descripción del grupo, Espero que les guste el grupo ❤️ e no seas un fantasma👻`
				...
				teks = `ADIÓS @${num.split('@')[0]} Demasiado tarde😂👋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ ⌛Espera un minuto, estoy procesando tu pedido, si no funciona, inténtalo de nuevo. ⌛',
					success: '️❬ ✔ ❭ Éxito 🖤',
					levelon: '❬ ✔ ❭ *leveling* *activado*',
					leveloff: ' ❬ X ❭  *leveling* *discapacitado*',
					levelnoton: '❬ X ❭ *leveling no esta activado*',
					levelnol: '*error* 0 °-°',
					error: {
				stick: '*Bien, falló, inténtalo de nuevo ^_^*',
				Iv: '𝗠𝗮𝗮𝗳 𝗹𝗶𝗻𝗸 𝘁𝗶𝗱𝗮𝗸 𝘃𝗮𝗹𝗶𝗱☹️'
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❌',
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS*',
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO DO LEO BOT*',
					...
					userB: `──「 LISTA 」──\nOlá gata !\nDesculpe, irmã. Você não está registrado como amigo de LEOBOT. Registre-se para fazer amizade com o bot LEO por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Leo|17\n\n──「 LEO BOT 」──`,
			...
			const ownerNumber = ["554591291250@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"554591291250@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["554591291250@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["554591291250@s.whatsapp.net"]//ubah nomor lo
			const premium = ["554591291250@s.whatsapp.net","554391575233@s.whatsapp.net","554391575233@s.whatsapp.net","554591291250@s.whatsapp.net","554391575233@s.whatsapp.net","554391575233@s.whatsapp.net","554591291250@s.whatsapp.net","554391575233@s.whatsapp.net","554591291250@s.whatsapp.net","554391575233@s.whatsapp.net"]
...
const get = require('got')
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("cadebot")){
			client.updatePresence(from, Presence.composing)
			reply("olha eu aqui seu peste")
	}
	
		if (messagesC.includes("bot")){
			client.updatePresence(from, Presence.composing)
			reply("fala comigo amor 💕💓")
	}
...
break
				...
				break 
					...
					if (Number(args[0]) === 1) {
						...
						reply('antilink activado con éxito ✓')
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN ☛፝⃟⧼͜🥶፝͜⃟𝓛𝓔𝓞፝⃟⧽͜🭝⃟͜🔥* 」\n*│+ wa.me/554591291250*╰──────*「 *LEO&ALEBOT* 」*────*\n\n*_SE QUER SER ADMIN DO  ☛፝⃟⧼͜🥶፝͜⃟𝓛𝓔𝓞፝⃟⧽͜🭝⃟͜🔥_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/+554591291250*╰──────*「 *☛፝⃟⧼͜🥶፝͜⃟𝓛𝓔𝓞፝⃟⧽͜🭝⃟͜🔥* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO  ☛፝⃟⧼͜🥶፝͜⃟𝓛𝓔𝓞፝⃟⧽͜🭝⃟͜🔥_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* LEO&ALEOFFICIAL\n* wa.me/+554591291250\n*\n\n\nEspero que tenham gostado do bot  ☛፝⃟⧼͜🥶፝͜⃟𝓛𝓔𝓞፝⃟⧽͜🭝⃟͜🔥'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
